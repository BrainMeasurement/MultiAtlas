...
typedef itk::Statistics::MABMISImageOperationFilter<ImageType, ImageType> ImageOperationType;
  ...
  typename ImageOperationType::Pointer imgoperator;
   ...
   void DoIt();
   int DiffeoDemonsRegistrationWithParameters(std::string fixedImageFileName, std::string  movingImageFileName,  std::string deformedImageFileName, std::string deformationFieldFileName, double sigmaDef, bool doHistMatch, std::vector<int> iterInResolutions);
   int DiffeoDemonsRegistrationWithInitialWithParameters(string  fixedImageFileName, string movingImageFileName, string initDeformationFieldFileName, string deformedImageFileName, string deformationFieldFileName,double sigmaDef, bool doHistMatch, std::vector<int> iterInResolutions);
